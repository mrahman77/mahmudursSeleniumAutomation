...
public class CommonAPI {
    ...
    public String browserstack_username= "mahmudurrahman5";
    public String browserstack_accesskey = "ZxGRGqdwomues9zGpBnx";
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false")String cloudEnvName,
                      @Optional("OS X") String os,@Optional("10") String os_version, @Optional("chrome-options") String browserName, @Optional("34")
                              String browserVersion, @Optional("https://www.harvard.edu/") String url)throws IOException {
        System.setProperty("webdriver.chrome.driver", "/Users/mahmudurrahman/Develop/MahmudursSeleniumAutomation/Generic/browser-driver/chromedriver");
        if(useCloudEnv==true){
